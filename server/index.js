  ...
  helmet({
    contentSecurityPolicy: {
      directives: {
        ...
        // googletagmanager.com: gtag.js for GA4. connect.facebook.net: Meta Pixel (disabled until enabled in /public/consent.js).
...
// Clean URLs for legal pages (HTML lives in /public/<slug>/index.html, copied to /dist).
// Listed explicitly so nginx-style "no clean URL rewrite" hosts also resolve them via Node.
app.get(['/politika-privatnosti', '/politika-privatnosti/'], (_req, res) => {
  res.setHeader('Cache-Control', 'public, max-age=3600')
  res.sendFile(path.join(DIST, 'politika-privatnosti', 'index.html'))
})
app.get(['/politika-kolacica', '/politika-kolacica/'], (_req, res) => {
  res.setHeader('Cache-Control', 'public, max-age=3600')
  res.sendFile(path.join(DIST, 'politika-kolacica', 'index.html'))
})

// English locale entrypoint (dist/en/index.html is generated by scripts/build-en-index.mjs).
app.get(['/en', '/en/'], (_req, res) => {
  res.setHeader('Cache-Control', 'no-cache, max-age=0, must-revalidate')
  res.sendFile(path.join(DIST, 'en', 'index.html'))
})
